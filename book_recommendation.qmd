...
```{r}
book_feature <- books[1:10000,c("book_author","publisher","category")]
...
dissimilarity2 = as.table(dissimilarity)

row.names(dissimilarity2)<-  books$ISBN[1:10000]
colnames(dissimilarity2)<- books$ISBN[1:10000]
...
user_books <- ratings %>%
  filter(user_id == user_id & isbn %in% books$isbn[1:10000]) %>%
